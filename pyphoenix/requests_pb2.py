...
_CONNECTIONSYNCREQUEST.fields_by_name['conn_props'].message_type = pyphoenix_dot_common__pb2._CONNECTIONPROPERTIES
_EXECUTEREQUEST.fields_by_name['statementHandle'].message_type = pyphoenix_dot_common__pb2._STATEMENTHANDLE
_EXECUTEREQUEST.fields_by_name['parameter_values'].message_type = pyphoenix_dot_common__pb2._TYPEDVALUE
_SYNCRESULTSREQUEST.fields_by_name['state'].message_type = pyphoenix_dot_common__pb2._QUERYSTATE
_UPDATEBATCH.fields_by_name['parameter_values'].message_type = pyphoenix_dot_common__pb2._TYPEDVALUE
...
CatalogsRequest = _reflection.GeneratedProtocolMessageType('CatalogsRequest', (_message.Message,), dict(
  ...
  __module__ = 'pyphoenix.requests_pb2'
